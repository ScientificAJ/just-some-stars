...
namespace JustSomeStars.Runtime.Commerce
{
    ...
    internal static class GalaxyProductMap
    {
        private static readonly Mapping[] Mappings =
        {
            ...
            new Mapping("cosmetic.captain.launch-navigator", "jss.cosmetic.captain.launch-navigator", "jss.cosmetic.captain.launch-navigator"),
            new Mapping("cosmetic.captain.launch-planetary", "jss.cosmetic.captain.launch-planetary", "jss.cosmetic.captain.launch-planetary"),
            new Mapping("cosmetic.captain.launch-starlight", "jss.cosmetic.captain.launch-starlight", "jss.cosmetic.captain.launch-starlight"),
            new Mapping("cosmetic.captain.star-charm", "jss.cosmetic.captain.star-charm", "jss.cosmetic.captain.star-charm"),
            new Mapping("cosmetic.captain.birthday-charm", "jss.cosmetic.captain.birthday-charm", "jss.cosmetic.captain.birthday-charm"),
            new Mapping("cosmetic.captain.ori-wristlink", "jss.cosmetic.captain.ori-wristlink", "jss.cosmetic.captain.ori-wristlink"),
            new Mapping("cosmetic.ori.festival-canopy", "jss.cosmetic.ori.festival-canopy", "jss.cosmetic.ori.festival-canopy"),
            new Mapping("cosmetic.ori.moon-chimes", "jss.cosmetic.ori.moon-chimes", "jss.cosmetic.ori.moon-chimes"),
            new Mapping("cosmetic.ori.comet-trail", "jss.cosmetic.ori.comet-trail", "jss.cosmetic.ori.comet-trail"),
            new Mapping("cosmetic.ship.builder-rig", "jss.cosmetic.ship.builder-rig", "jss.cosmetic.ship.builder-rig"),
            new Mapping("cosmetic.ship.signal-tower", "jss.cosmetic.ship.signal-tower", "jss.cosmetic.ship.signal-tower"),
            new Mapping("cosmetic.ship.comet-launch", "jss.cosmetic.ship.comet-launch", "jss.cosmetic.ship.comet-launch"),
            new Mapping("cosmetic.lens.rocket-window", "jss.cosmetic.lens.rocket-window", "jss.cosmetic.lens.rocket-window"),
            new Mapping("cosmetic.lens.starlight-compass", "jss.cosmetic.lens.starlight-compass", "jss.cosmetic.lens.starlight-compass"),
            new Mapping("cosmetic.clubhouse.moon-chair", "jss.cosmetic.clubhouse.moon-chair", "jss.cosmetic.clubhouse.moon-chair"),
            new Mapping("cosmetic.clubhouse.ori-radio", "jss.cosmetic.clubhouse.ori-radio", "jss.cosmetic.clubhouse.ori-radio"),
            new Mapping("cosmetic.photo.captain-pose", "jss.cosmetic.photo.captain-pose", "jss.cosmetic.photo.captain-pose"),
            new Mapping("cosmetic.photo.stargazer-pose", "jss.cosmetic.photo.stargazer-pose", "jss.cosmetic.photo.stargazer-pose"),
            new Mapping("cosmetic.crew.launch-homecoming", "jss.cosmetic.crew.launch-homecoming", "jss.cosmetic.crew.launch-homecoming"),
            new Mapping("cosmetic.crew.birthday-expedition", "jss.cosmetic.crew.birthday-expedition", "jss.cosmetic.crew.birthday-expedition"),
        };
