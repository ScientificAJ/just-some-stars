...
| JSS-014 | The accepted Stage 1 proof uses static whole-character PNG cutouts, so legs and other body parts do not animate during movement. Stage 3 resolves the Captain; bespoke crew and Ori replacements remain. | Replacement Task 12 Stage 4 character production | None; Captain resolved, remaining proof actors still intentionally temporary |
